...
void setup(){
  ...
  #ifndef isDUE
  SPI.setClockDivider(SPI_CLOCK_DIV4); //Set according to the board you are using
  #endif
  ...
  //while (!WiredSerial) ; //required by Leonardo http://arduino.cc/en/Serial/IfSerial (ads129n requires 3.3v signals,)
  delay(200);  
